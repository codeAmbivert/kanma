    ...
    <div className="inline-flex items-center">
      ...
      >
        <input
          ...
          type="checkbox"
          {...props}
          className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-nrvDarkBlue transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-nrvDarkBlue before:opacity-0 before:transition-opacity checked:border-gray-900 checked:bg-nrvDarkBlue checked:before:bg-nrvDarkBlue"
        />
